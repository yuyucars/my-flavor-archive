      ...
      <div className="text-center space-y-8 px-4">
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className="flex items-center gap-3 px-8 py-3 bg-white border border-stone-200 rounded-full shadow-sm hover:shadow-md transition-all text-stone-700 font-medium mx-auto"
          >
